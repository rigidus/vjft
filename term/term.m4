...
XY(KEY_BACKTICK, 1, "\x60", 0)
XY(KEY_SHIFT_BACKTICK_IS_TILDE, 1, "\x7e", 0)
...
XY(KEY_CYRILLIC_SHCHA, 2, "щ", 0)
XY(KEY_SHIFT_CYRILLIC_SHCHA, 2, "Щ", 0)
XY(KEY_ALT_CYRILLIC_SHCHA, 3, "\x1bщ", 0)
XY(KEY_SHIFT_ALT_CYRILLIC_SHCHA, 3, "\x1bЩ", 0)
XY(KEY_P, 1, "p", 0)
XY(KEY_SHIFT_P, 1, "P", 0)
XY(KEY_ALT_P, 2, "\x1b\x70", 0)
XY(KEY_SHIFT_ALT_P, 2, "\x1b\x50", 0)
XY(KEY_CTRL_P, 1, "\x10", 0)
XY(KEY_ALT_CTRL_P, 2, "\x1b\x50", 0)
XY(KEY_CYRILLIC_ZE, 2, "з", 0)
XY(KEY_SHIFT_CYRILLIC_ZE, 2, "З", 0)
XY(KEY_ALT_CYRILLIC_ZE, 3, "\x1bз", 0)
XY(KEY_SHIFT_ALT_CYRILLIC_ZE, 3, "\x1bЗ", 0)
XY(KEY_LEFT_SQUARE_BRACKET, 1, "[", 0)
XY(KEY_SHIFT_LEFT_SQUARE_BRACKET_IS_LEFT_CURVE_BRACKET, 1, "{", 0)
...
XY(KEY_CYRILLIC_KHA, 2, "х", 0)
XY(KEY_SHIFT_CYRILLIC_KHA, 2, "Х", 0)
XY(KEY_ALT_CYRILLIC_KHA, 3, "\x1bх", 0)
XY(KEY_SHIFT_ALT_CYRILLIC_KHA, 3, "\x1bХ", 0)
XY(KEY_RIGHT_SQUARE_BRACKET, 1, "]", 0)
XY(KEY_ALT_RIGHT_SQUARE_BRACKET, 2, "\x1b\x5d", 0)
